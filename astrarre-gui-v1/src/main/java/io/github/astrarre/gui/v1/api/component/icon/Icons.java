...
public class Icons {
	...
	/**
	 * a 7x7 icon of a shaded semi inverted dark blue square with the lowercase letter 'i' on it
	 */
	...
	/**
	 * a 7x7 icon of a shaded semi inverted dark red square with the '!' character on it
	 */
	...
	/**
	 * a 8x8 icon of a shaded semi inverted dark green square with a checkmark on it
	 */
	...
	/**
	 * a 8x8 icon of a shaded semi inverted red square with an 'x' in the middle
	 */
