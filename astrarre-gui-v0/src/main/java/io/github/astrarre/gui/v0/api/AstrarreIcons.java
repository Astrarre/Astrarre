...
public class AstrarreIcons {
	...
	/**
	 * a 9x9 icon of a shaded blue square with the lowercase letter 'i' on it
	 */
	public static final TexturePart INFO = icon(0, 0, 7, 7);
	/**
	 * a 9x9 icon of a shaded dark blue square with the lowercase letter 'i' on it
	 */
	public static final TexturePart INFO_DARK = icon(0, 7, 7, 7);
	/**
	 * a 9x9 icon of a shaded red square with the '!' character on it
	 */
