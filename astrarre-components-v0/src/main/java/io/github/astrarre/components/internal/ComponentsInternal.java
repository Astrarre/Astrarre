...
public class ComponentsInternal {
	public static final ComponentManager<Entity> MANAGER = ComponentManager.newManager("astrarre-components", "entity");
	public static final ComponentManager<PlayerEntity> PLAYER_MANAGER = ComponentManager.newPlayerManager("astrarre-components", "player");
