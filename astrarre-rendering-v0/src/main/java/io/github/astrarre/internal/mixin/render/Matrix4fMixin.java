package io.github.astrarre.internal.mixin.render;
...
public class Matrix4fMixin implements Matrix4fAccess {
	...
	@Override
	public void astrarre_translate(float x, float y, float z) {
		this.a30 += this.a00 * x + this.a10 * y + this.a20 * z;
		this.a31 += this.a01 * x + this.a11 * y + this.a21 * z;
		this.a32 += this.a02 * x + this.a12 * y + this.a22 * z;
		this.a33 += this.a03 * x + this.a13 * y + this.a23 * z;
	}
}
