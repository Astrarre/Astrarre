 ...
 */
public class RegistryAccessHelper<T, F> extends AbstractInputAccessHelper<T, F> {
	 ...
	 */
	public static <I, T, F> RegistryAccessHelper<T, F> create(Registry<T> registry, AbstractInputAccessHelper<I, F> copyFrom, Function<I, T> mapper) {
	...
	public RegistryAccessHelper(Registry<T> registry, AbstractInputAccessHelper<T, F> copyFrom) {
